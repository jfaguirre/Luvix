        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MensajeTexto = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "Apellido", "Email", "Estado", "FechaRegistro", "FotoPerfil", "Genero", "Nombre", "Password" },
                values: new object[,]
                {
                    { 1, "Aguirre Aparicio", "jfaguirrex@outlook.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Masculino", "Juan Francisco", "Admin2025@" },
                    { 2, "Santana Martínez", "mesantana@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Femenino", "Margarita Elizabeth", "Admin2025@" },
                    { 3, "Castellanos Sánchez", "aycastellanos@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Femenino", "Andrea Yamileth", "Admin2025@" },
                    { 4, "García Melgar", "asgarcia@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Femenino", "Alisson Stefany", "Admin2025@" },
                    { 5, "Guerrero Mena", "frguerrero@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Femenino", "Fátima Roció", "Admin2025@" },
                    { 6, "Echegoyen Henríquez", "ryechegoyen@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Masculino", "Rodrigo Yohalmo", "Admin2025@" },
                    { 7, "López Ramírez", "odlopez@gmail.com", "activo", new DateTime(2025, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "Masculino", "Oscar Daniel", "Admin2025@" }
                });
